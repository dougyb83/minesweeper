...
Our target audience includes casual gamers looking for a quick mental challenge, puzzle enthusiasts, and retro game lovers seeking a nostalgic experience. Whether you're a seasoned minesweeper veteran or a newcomer to the game, our project caters to all skill levels. With its responsive design, the game can be played on a variety of devices, including desktops, laptops, tablets, and mobile phones, making it accessible to players on the go.
...
As this website's purpose is to provide a gaming experience for the user I have decided to make the home page in the style of a gaming main menu. It will be simple and easy to understand with options provided for different game difficulty levels.
Once the difficulty setting has been selected the appropriate game page will load. The game board will occupy most of the screen on mobile devices while still making navigation buttons and information displays available. This will give the user the best gameplay experience while still giving them full navigation.
On desktops and laptops, there is more screen real estate so the game board won't fill the screen in the same way but will be more central with space on all four sides. This will be more pleasing to the user's eye and will provide a better gameplay experience by keeping the mouse movements within a smaller area.
...
- As a new site user, I would like to easily understand the rules and objectives of the game, so that I can start playing without confusion or hesitation.
...
- As a returning site user, I would like to choose the difficulty level so that I can tailor the gameplay experience to my skill level.
...
- **Difficulty selection**
  ...
  - There are three possible difficulty options for the user to choose from; Easy, Medium, and Expert!
    This gives the user the ability to increase the difficulty as they become better at the game.
...
- **How to Play Modal**
  ...
  - This feature is a pop-up modal that gives the user detailed instructions on how to play the Minesweeper game.
  ...
  - When the user is finished with the instructions they can easily close the modal. This can be achieved by clicking anywhere on the screen, by clicking the 'X' to close button, or by hitting 'esc' if playing on a PC/laptop.

  ![screenshot](documentation/features/feature02.png)
- **On Screen Display**

  - The On Screen Display lets the user know how many mines are hidden on the game board as well as shows them how much time has elapsed since starting the game.
  ...
  - The timer displays in seconds and will continue to increase until either the game has been won or lost at which point the timer stops. if the game is reset the time returns to zero.

  ![screenshot](documentation/features/feature03.png)
- **Game Won Modal**

  - This is another pop-up modal that is only shown when the user has won the game.
  - The modal tells the user how long it took them to finish the game and also shows them their best time.
  - The best time is then stored in local storage so that the user can try to beat it any time they return to the page using the same device and browser.

  ![screenshot](documentation/features/feature04.png)
- **Controls Bar**

  - The Controls bar allows the user to return to the homepage, reset the game, view the how to play instructions, or toggle the game volume on or off.

  ![screenshot](documentation/features/feature05.png)
- **The Game Board**

  - The Game board will be a different size depending on which difficulty the user selects.
  - All tiles are clickable. When clicked, the tile disappears and reveals what is underneath. This could be a mine, a number hint, or a blank space.
  - Any tile that has not been revealed can have a flag placed on it. When a flag is placed that tile cannot be revealed by the user until the flag is removed.
...
- **Confirmation page**
  ...
  - Users are redirected to this page after successfully sending a message to the site owner.
  - This gives the user peace of mind knowing that the message has definitely been processed and lets them know that they can expect a reply soon.
...
- **Footer**
  ...
  - Here users can find links to the page's social media accounts and the contact page.
...
- Custom Game Difficulty
  - I would like to add the ability for the user to choose a custom grid size as well as a custom amount of mines.
- Leader Board
...
| [W3Schools](https://www.w3schools.com/jsref/default.asp)                 | entire site        | reference to all JavaScript methods           |
...
| [StackOverflow](https://stackoverflow.com/a/7715161)                     | home page          | how to query screen size                      |
...
| [StackOverflow](https://stackoverflow.com/a/4236294)                     | game page          | how to add an event listener for right-click  |
